package com.jiansong.controller; /**
 * Created by jery on 2016/11/23.
 */

import com.jiansong.service.ActTaskService;
import com.jiansong.service.ActDeployService;
...
public class MyRestController {
    @Autowired
    private ActTaskService myService;

    @Resource
    private ActDeployService actDeployService;

//    //自定义流程化
//    @RequestMapping(value = "/customizationProcess", method = RequestMethod.GET)
//    public void customizationProcess() {
//        workService.customizationProcess();
//    }
//
//    //开启流程实例
